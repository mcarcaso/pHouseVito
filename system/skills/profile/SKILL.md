...
```bash
./vito memory search "durable user preference changed going forward remember default" --limit 8
./vito memory search "family wife parents siblings personal update durable" --limit 8
./vito memory search "tools workflow coding UI dashboard durable preference" --limit 8
./vito memory search "fitness injury training workout durable preference equipment" --limit 8
./vito memory search "travel packing hotel airport durable preference" --limit 8
./vito memory search "music guitar Bible music durable preference" --limit 8
```
