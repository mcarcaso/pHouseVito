...
```bash
node system/skills/mcp-client/mcp-client.mjs list <skill-md-or-url-or-dir>
node system/skills/mcp-client/mcp-client.mjs call <skill-md-or-url-or-dir> <tool_name> '<json_args>'
node system/skills/mcp-client/mcp-client.mjs batch <skill-md-or-url-or-dir> '<json_steps>'
node system/skills/mcp-client/mcp-client.mjs schema <skill-md-or-url-or-dir> <tool_name>
```
...
```bash
node system/skills/mcp-client/mcp-client.mjs call user/skills/tavily/SKILL.md tavily_search '{"query":"Forrest Frank Nashville GEODIS Park tickets","max_results":5}'
```
...
```bash
node system/skills/mcp-client/mcp-client.mjs list 'https://mcp.example.com/mcp?apiKey=${API_KEY}'
```
