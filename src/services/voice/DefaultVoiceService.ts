        ...
        session: {
          ...
          tools: [
            ...
            },
            {
              ...
              name: "ask_vito_async",
              description:
                "Start a background authoritative Vito investigation and immediately return a task ID so conversation can continue. The companion tracks completion; never poll it automatically.",
              parameters: {
                type: "object",
