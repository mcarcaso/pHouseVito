...
function Settings() {
  ...
  if (!config) return <div className="settings-container">Loading...</div>;
  ...
  return (
    <div className="settings-container">
      ...
      <section className="settings-section">
        ...
        <p className="section-desc">Controls what goes into the system prompt for each message.</p>
        ...
        <div className="setting-row">
          <label>Include tool calls in current session</label>
          <input
            type="checkbox"
          ...
          />
          <span className="setting-hint">Show tool call/result pairs in session transcript</span>
        </div>
        ...
        <div className="setting-row">
          <label>Include tool calls in cross-session</label>
          <input
            type="checkbox"
          ...
          />
          <span className="setting-hint">Show tool call/result pairs from other sessions</span>
        </div>
        ...
        <div className="setting-row">
          ...
          <input
            ...
            min={0}
          />
          <span className="setting-hint">Max memories included via semantic search</span>
        </div>
      </section>

      <section className="settings-section">
        <h3>Compaction</h3>
        <p className="section-desc">When uncompacted messages exceed the threshold, the oldest half are summarized into long-term memories.</p>
        ...
        <div className="setting-row">
          ...
          <input
            ...
            step={50}
          />
          <span className="setting-hint">Trigger compaction after this many uncompacted messages</span>
        </div>
      </section>
    </div>
  );
