...
export const appNameSchema = z
  ...
  .min(1)
  .max(100)
  .regex(/^[A-Za-z0-9][A-Za-z0-9._-]*$/, "Invalid app name");

export const appFilePathSchema = z
  .string()
  .min(1)
  .refine((value) => {
...
export const appReadFileCommandSchema = z
  .object({
...
export const appReadFileResultSchema = z
  .object({
    content: z.string(),
