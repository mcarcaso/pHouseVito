            ...
            jobs.map((job) => (
              <div key={job.name} className={`job-card ${job.oneTime ? 'one-time' : ''}`}>
                <div className="job-header">
                  ...
                  <button onClick={() => handleDelete(job.name)} className="delete-btn">
                    Delete
                  </button>
                </div>
                <div className="job-details">
                  ...
                  <div className="job-detail">
                    <strong>Timezone:</strong> <span>{job.timezone || "America/New_York"}</span>
                  </div>
                  <div className="job-detail">
                    <strong>Session:</strong> <span>{job.session}</span>
                  </div>
                  <div className="job-detail">
